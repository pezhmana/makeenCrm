...
//    }
        ...
        public
        function delete(UserCreateRequest $request, $id = Null)
        {
            User::find($id)->delete();
            return response()->json('کاربر با موفقیت حذف شد');
        }
        ...
        public
        function index(UserCreateRequest $request, $id = Null)
        {
            $User = new User();
            if ($id != Null) {
...
//       }
        ...
        public
        function adminLogin(UserCreateRequest $request)
        {
            $user = User::where('phone', $request->phone)->first();
            if (!hash::check($request->password, $user->password)) {
                return response()->json('رمز ورود اشتباه است');
        ...
        public
        function adminAssign(UserCreateRequest $request)
        {
            $user = User::where('phone', $request->phone)->first();
